...
A comparison with more precise calculations of the range using Monte-Carlo techniques is shown in \figref{fig:range_comparison}.
\begin{figure}
    \centering
...
\begin{figure}
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \input{drawings/feyn_brems_loop_vacuum}
    ...
    \begin{subfigure}[t]{0.33\textwidth}
        \centering
        \input{drawings/feyn_brems_loop_box}
        \caption{Box Diagram.}
    ...
    \begin{subfigure}{0.96\textwidth}
        \vspace{0.5cm}
        \centering
        \input{drawings/feyn_brems_loop_vertex}
    ...
    \begin{subfigure}{0.96\textwidth}
        \vspace{0.5cm}
        \centering
        \input{drawings/feyn_brems_double}
...
\begin{figure}
    \centering
    \input{drawings/feyn_brems_coulomb}
...
Similar to the vacuum polarization, this correction is not included in the simulation PROPOSAL, due to the small energy loss as shown in \figref{fig:brems_dsigma}.
...
\begin{figure}
    \centering
    \input{drawings/feyn_epair_coulomb}
...
\begin{figure}
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \input{drawings/feyn_epair_loop_vacuum}
        \caption{Vacuum Polarization.}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \input{drawings/feyn_epair_loop_brems}
...
The cross-sections are in good agreement with the parametrizations described previously, shown in \figref{fig:epair_dsigma_loop_compare}.
...
\end{align}
with the coefficients $a_k$ listed in \tabref{tab:photo_hard}.
...
The effect of the different parametrizations of $\sigma_{\gamma N}$ on the differential cross-section is shown in \figref{fig:photo_dsigma_compare}.
