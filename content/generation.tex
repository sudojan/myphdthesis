...
The cosmic-ray spectrum is shown in \figref{fig:cosmic_rays} together models describing the composition of the nuclei.
...
These showers can be categorized into hadronic, muonic and electromagnetic shower components, that are illustrated in \figref{fig:air_shower_components}.
...
\textbf{The muonic showercomponent} mainly originates from the hadronic shower component and produce just a few secondaries compared to the other shower particles.
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{./plots/nu_spectrum.pdf}
