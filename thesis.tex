...
\Language{en-US}
\Keywords{PHD thesis\sep Dissertation\sep Neutrino Astronomy\sep IceCube}
...
% to create a pdf/a file, pdfx must be used, which already includes hyperref
% see https://tex.stackexchange.com/a/89073
% \hypersetup{pdfusetitle, unicode, linkbordercolor=tugreen, citebordercolor=tugreen}
\usepackage{bookmark}
...
\input{content/generation.tex}
\input{content/detection.tex}
\input{content/interactions.tex}
...
\input{content/a_study.tex}
\input{content/a_software.tex}
% \input{content/b_bugaev_q2_int}
